  ...
  return (
    <footer id={id} className="bg-[#101828] ">
      <div className="mx-auto max-w-7xl px-6 py-8">
        {/* Mobile: logo ao lado do contato e redes embaixo */}
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-4 shrink-0">
              <Image
                ...
                width={140}
                height={100}
                className="w-29 h-auto sm:w-28"
                sizes="(max-width: 640px) 96px, 112px"
              />
            </div>

            <div className="text-white text-center flex-1 min-w-0">
              <p className="font-semibold">Contato</p>
              <p className="mt-1 opacity-90">
                <a
                  href={buildWhatsAppLink("informacoes")}
                  target="_blank"
              ...
              <p className="opacity-90">
                <a href={`mailto:${email}`} className="hover:underline" aria-label="Enviar e-mail">
                  {email}
                </a>
              </p>
            </div>
        ...
        {/* Desktop (md+): layout original com 3 colunas */}
        <div className="hidden md:grid grid-cols-1 items-center gap-4 md:grid-cols-3 p-4">
